/* ============================================================
   스킬판 — 데이터 + 렌더링
   링크·별(star) gh 검증 완료(2026-06-22): anthropics/skills 153k · obra/superpowers 235k
      · claude-mem 83.5k · understand-anything 65.3k · claude-video 2.2k. (karpathy는 repo 미확정→검색 링크)
   ============================================================ */
...
const SKILLS = [
  ...
  { id:"karpathy-guidelines", name:"실수 줄이는 규칙", cat:"flow", badge:"pick",
    desc:"클로드의 흔한 실수를 줄이는 4가지 규칙(질문 먼저·단순하게·시키는 것만).",
    take:"설치 10초, <b>체감은 즉시.</b>",
    src:"Karpathy 가이드라인", url:"https://github.com/search?q=karpathy+claude+code+skill&type=repositories" },

  { id:"deep-research", name:"딥리서치", cat:"research", badge:"official",
    desc:"여러 사이트를 교차검증해 출처까지 단 리포트를 만들어요.",
    take:"<b>구글링 10번</b> 할 걸 한 번에.",
    src:"Anthropic 공식", url:DOCS },
